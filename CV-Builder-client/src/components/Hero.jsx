    ...
    return (
        <>
            ...
            <div className="flex flex-col w-2/3 h-1/4 shadow-lg rounded-2xl bg-white justify-evenly items-center">
                ...
                <button onClick = { () => props.change(<TheBasics change = {props.change} refresh={props.refresh}/>)} className="h-1/6 w-1/3 bg-blue-400 text-white rounded-md hover:bg-blue-500 font-medium text-xl">Get Started!</button>
            </div>
        </>
    )
}